...
main = runChecks
  ...
  , fmap and $
      sequence
        ...
        , expectNormalizedFiles "stdlib list head option normalization" stdlibHostedSources "stdlib-list-head-option-sample" "(u64 9)"
        ...
        , expectNormalizedFiles "stdlib list append length normalization" stdlibHostedSources "stdlib-list-append-length-sample" "(u64 3)"
        , expectNormalizedFiles "stdlib list append empty-left normalization" stdlibHostedSources "stdlib-list-append-empty-left-sample" "(u64 44)"
        , expectNormalizedFiles "stdlib list filter length normalization" stdlibHostedSources "stdlib-list-filter-length-sample" "(u64 2)"
        , expectNormalizedFiles "stdlib list any true normalization" stdlibHostedSources "stdlib-list-any-true-sample" "True"
        , expectNormalizedFiles "stdlib list any false normalization" stdlibHostedSources "stdlib-list-any-false-sample" "False"
        , expectNormalizedFiles "stdlib list all true normalization" stdlibHostedSources "stdlib-list-all-true-sample" "True"
        , expectNormalizedFiles "stdlib list all false normalization" stdlibHostedSources "stdlib-list-all-false-sample" "False"
        , expectNormalizedFiles "stdlib list find normalization" stdlibHostedSources "stdlib-list-find-sample" "(u64 3)"
        , expectNormalizedFiles "stdlib list find none normalization" stdlibHostedSources "stdlib-list-find-none-sample" "(u64 88)"
        , expectNormalizedFiles "stdlib list count normalization" stdlibHostedSources "stdlib-list-count-sample" "(u64 2)"
        , expectNormalizedFiles "stdlib list reverse head normalization" stdlibHostedSources "stdlib-list-reverse-head-sample" "(u64 5)"
        ...
        , expectNormalizedFiles "stdlib Nat mul normalization" stdlibHostedSources "stdlib-nat-mul-sample" "(u64 6)"
        , expectNormalizedFiles "stdlib Nat mul zero normalization" stdlibHostedSources "stdlib-nat-mul-zero-sample" "(u64 0)"
        , expectNormalizedFiles "stdlib Nat mul zero-left normalization" stdlibHostedSources "stdlib-nat-mul-zero-left-sample" "(u64 0)"
        , expectNormalizedFiles "stdlib Nat pred zero normalization" stdlibHostedSources "stdlib-nat-pred-zero-sample" "(u64 0)"
        , expectNormalizedFiles "stdlib Nat pred succ normalization" stdlibHostedSources "stdlib-nat-pred-succ-sample" "(u64 2)"
        ...
        , expectNormalizedFiles "List recursion append length normalization" stdlibHostedSources "list-recursion-append-length" "(u64 5)"
        , expectNormalizedFiles "List recursion filter length normalization" stdlibHostedSources "list-recursion-filter-length" "(u64 2)"
        , expectNormalizedFiles "List recursion any normalization" stdlibHostedSources "list-recursion-any-small" "True"
        , expectNormalizedFiles "List recursion all normalization" stdlibHostedSources "list-recursion-all-small" "True"
        , expectNormalizedFiles "List recursion find normalization" stdlibHostedSources "list-recursion-find-large" "(u64 3)"
        , expectNormalizedFiles "List recursion count normalization" stdlibHostedSources "list-recursion-count-small" "(u64 2)"
        , expectNormalizedFiles "List recursion reverse head normalization" stdlibHostedSources "list-recursion-reverse-head" "(u64 3)"
