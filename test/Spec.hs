...
main = do
  ...
  ok169el <- expectFreestandingCodegenFiles "limine kernel frame allocator semantics state load from Silt" ["examples/limine.silt"] "limine-entry" "silt_layout_KernelFrameAllocatorSemanticsState state_"
