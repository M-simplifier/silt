...
expect_norm stdlib-list-any-true-sample "True"
expect_norm stdlib-list-any-false-sample "False"
expect_norm stdlib-list-all-true-sample "True"
expect_norm stdlib-list-all-false-sample "False"
expect_norm stdlib-list-find-sample "(u64 3)"
expect_norm stdlib-list-find-none-sample "(u64 88)"
expect_norm stdlib-list-count-sample "(u64 2)"
...
expect_norm list-recursion-any-small "True"
expect_norm list-recursion-all-small "True"
expect_norm list-recursion-find-large "(u64 3)"
expect_norm list-recursion-count-small "(u64 2)"
